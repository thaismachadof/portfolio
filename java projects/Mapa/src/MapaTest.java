...
public class MapaTest {
    ...
    public void testeIsEmpty() {
        rodarTesteParaClearEIsEmpty(mapaUsandoArrayUnico);
    ...
    public void testeRemove() {
        rodarTesteParaRemove(mapaUsandoArrayUnico);
    ...
    private void rodarTesteParaRemove(Map<Long, String> mapa) {
        ...
        assertFalse(mapa.containsKey(1L));
        assertTrue(mapa.containsKey(2L));
        assertTrue(mapa.containsKey(3L));
