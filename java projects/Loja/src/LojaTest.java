...
public class LojaTest {
    ...
    public void setUp() {
        ...
        livro1 = new Livro(12345, "Da Terra à Lua", "Julio Verne", null, 1865, Categoria.FICCAO);
    ...
    public void testarVendaParaProdutoNaoExistente() throws
        ...
        Livro livroNaoExistente = new Livro(1010101, "Blah", "Qualquer coisa", null, 2000, Categoria.ARTE);
        String recibo = loja.receberPedido(livroNaoExistente, 5, comprador);
        assertNull(recibo);
    }

    @Test
    public void testar3LivrosDidaticos() throws EnderecoInvalidoException, EstoqueInsuficienteException, ItemNaoExisteNoCatalogoException, ErroNoPagamentoException {
        Livro livrod = new Livro(978-85-2212-584-5, "CALCULO, Vol.2", "James Stewart", null, 2017, Categoria.LIVRO_DIDATICO);
        livrod.setPrecoEmReais(140f);
        loja.incluirItem(livrod);

        loja.receberPedido(livrod, 3, comprador);
    }
}