...
public class ContaCorrente {
    ...
    public void depositar(float valor) throws ValorNaoPositivoException {
        // valida o parâmetro
        if (valor <= 0) {
    ...
    public void sacar (float valor)
            throws ValorNaoPositivoException, SaldoInsuficienteException {
     ...
     */
    public void transferir(float valor, ContaCorrente contaDestino) throws ValorNaoPositivoException, SaldoInsuficienteException {
        // valida o parâmetro
        if (valor <= 0) {
            throw new ValorNaoPositivoException();
        }
        ...
        if (valor > saldoEmReais + LIMITE_CHEQUE_ESPECIAL) {
            throw new SaldoInsuficienteException((saldoEmReais + LIMITE_CHEQUE_ESPECIAL)-valor);
        }
